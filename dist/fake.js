...
exports.typeFakers = {
    ...
    'ID': {
        defaultOptions: {},
        generator: () => {
            return (parentType) => new Buffer(parentType.name + ':' + faker.random.number({ max: 9999999999 }).toString()).toString('base64');
        }
    },
};
const fakeFunctions = {
    ...
    imageUrl: {
        ...
        func: (height, width, category, randomize) => faker.image.imageUrl(height, width, category, randomize, false),
    },
    // Internet section
